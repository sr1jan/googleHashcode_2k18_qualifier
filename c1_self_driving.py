...
def next_schedule(schedule, bonus_rides, total_steps):
    ...
    for vehicle in schedule:
        ...
        ride = bonus_rides[0]
        # for i,r in enumerate(bonus_rides):
        #     if distance(r[1], r[2]) > 500:
        #         ride = bonus_rides[i]
        #         break
        #     else:
        #         ride = bonus_rides[0]
        ...
        # else:
        #     print(f"{vehicle}, {ride[0]}, {distance(ride[1], ride[2])}, {finish_time},", *ride, sep=" ")
...
if __name__ == '__main__':
    ...
    for i in range(vh):
        ...
        # print(f"{i}, {ride[0]}, {distance(ride[1], ride[2])}, {cumm_steps},", *ride, sep=" ")
